					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'): ',
								_elm_lang$core$Basics$toString(post.result))))))) : (_elm_lang$core$Native_Utils.eq(post.target, -1) ? _elm_lang$html$Html$text(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'Rolled 1d100: ',
				...
				_0: narrative ? A2(
					...
					},
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A3(_user$project$Kami$renderSkillOption, 'narr10', 'd10', 999),
								_1: {ctor: '[]'}
							}
						}
					}) : A2(
...
if (typeof _user$project$Kami$main !== 'undefined') {
    _user$project$Kami$main(Elm['Kami'], 'Kami', undefined);
}
